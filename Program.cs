...
namespace Perfect_Udyr
{
    ...
    class Program
    {
        ...
        private static void Loading_OnLoadingComplete(EventArgs args)
        {
            ...
            FarmingMenu.Add("WlaneclearHealth", new Slider("Health < %", 60, 0, 100));
            FarmingMenu.Add("RLaneClear", new CheckBox("Use R LaneClear"));
            ...
            MiscMenu.Add("autoQ", new CheckBox("Use E to Flee/Escape"));         
            ...
            MiscMenu.Add("Qkills", new CheckBox("Use Q KillSteal"));
            MiscMenu.Add("Ekills", new CheckBox("Use E KillSteal"));
